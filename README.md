...
|---|---|---|
| ai-team | Specialist sub-agents for end-to-end AI/ML work spanning research, data, modeling, and deployment | [deepresearch](./agents/deepresearch/), [autoresearch](./agents/autoresearch/), [ai-scientist](./agents/ai-scientist/), [data-scientist](./agents/data-scientist/), [ml-engineer](./agents/ml-engineer/), [data-engineer](./agents/data-engineer/), [mlops-engineer](./agents/mlops-engineer/), [llm-architect](./agents/llm-architect/), [prompt-optimization](./agents/prompt-optimization/), [nlp-engineer](./agents/nlp-engineer/), [computer-vision-engineer](./agents/computer-vision-engineer/), [recommendation-engine](./agents/recommendation-engine/), [vector-database-engineer](./agents/vector-database-engineer/), [data-visualization](./agents/data-visualization/) |
